...
var hasOwn = function (o, key) { return Object.prototype.hasOwnProperty.call(o, key); };
var camelize = function (str) {
    return str.replace(/-(\w)/g, function (_, c) { return (c ? c.toUpperCase() : ""); });
};
var capitalized = function (str) { return str.charAt(0).toUpperCase() + str.slice(1); };
var toHandleKey = function (eventName) {
...
var readonlyHandlers = {
    ...
    set: function (target, key, value) {
        console.warn("".concat(key, " set \u5931\u8D25\uFF0C\u56E0\u4E3Atarget\u662Freadonly"), target);
        return true;
    },
};
...
function createReactiveObject(raw, baseHandlers) {
    if (!isObject(raw)) {
        console.warn("target ".concat(String(raw), " \u5FC5\u987B\u662F\u4E00\u4E2A\u5BF9\u8C61"));
        return raw;
    }
...
var emit = function (instance, eventName) {
    ...
    var handleName = toHandleKey(camelize(eventName));
...
var renderSlots = function (slots, name) {
    var slot = slots[name];
    if (slot) {
